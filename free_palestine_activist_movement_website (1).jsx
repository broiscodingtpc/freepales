...
export default function FreePalestineSite() {
  ...
  const pressLinks = [
    ...
    },
    {
      ...
      href: "https://windsorstar.com/news/local-news/1m-gift-gone-big-donors-desert-uwindsor-in-wake-of-controversial-deal-with-pro-palestinian-protesters",
    },
  ];
            ...
            <div className="relative group">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  ...
                  <div className="text-sm text-neutral-300">Palestinian Activist</div>
                </div>
              </div>
            </div>
          </div>
